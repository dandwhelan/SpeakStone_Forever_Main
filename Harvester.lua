...
local function Enabled()
    return SpeakStone_ForeverMainDB and SpeakStone_ForeverMainDB.harvestEnabled
        and not StandaloneActive()
end
addon.HarvestEnabled = Enabled

local function Store()
    SpeakStone_ForeverMainDB.harvest = SpeakStone_ForeverMainDB.harvest or {}
    local h = SpeakStone_ForeverMainDB.harvest
...
function addon.HarvestMigrate()
    ...
    local old = SpeakStone_ForeverMainDB.missingCaptures
    if old and old.quests then
        ...
        SpeakStone_ForeverMainDB.missingCaptures = nil
    end
